document.getElementById("tirar-carta").addEventListener("click", () => tirarUmaCartaAleatoriaDoBaralho());

async function criarBaralhoEmbaralhado(){
    const url = "https://deckofcardsapi.com/api/deck/new/shuffle/?deck_count=1";
    const resposta = await fetch(url); //fetch retorna uma promisse
    return await resposta.json();//.json retorna uma promisse
}
